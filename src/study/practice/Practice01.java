...
//		a. $ystem           가능
//		b. channel#112      불가능 : 중간에 특수문자 안됨
//		c. 7eleven			불가능 :  숫자로 시작
//		d. newmember		가능	 : nuwMenber 로 써주는게 더 좋다.
//		e. $MAX_NUM			가능
//		f. hello@com		불가능 : 중간에 특수문자 안됨
//		g. int				불가능 : int 라는 정수형 타입이 있어서 불가능

		//7. 다음중 변수 초기화가 잘못 된 것은?  c
//		a. int b = 255;
//		b. String s = "T";
//		c. char answer = 'no';   //잘못됨
//		d. char flag = 'F';
